...
public class DelegatingAsyncResultFuture implements BiConsumer<Object, Throwable> {
    ...
    public synchronized void setOutputFactory(Function<Object, RowData> outputFactory) {
        this.outputFactory = outputFactory;
    }

    public synchronized CompletableFuture<?> createAsyncFuture(
    ...
    @Override
    public synchronized void accept(Object o, Throwable throwable) {
        if (throwable != null) {
