...
public class AsyncCodeGenerator {
     ...
     * @param outRowClass The class used to generate the output RowData
    ...
    public static GeneratedFunction<AsyncFunction<RowData, RowData>> generateFunction(
            ...
            RowType inputType,
            RowType returnType,
            Class<? extends RowData> outRowClass,
    ...
    private static String generateProcessCode(
        ...
        values.put("delegatingFuture", delegatingFutureTerm);
        values.put("collectorTerm", collectorTerm);
        values.put("typeTerm", outRowClass.getCanonicalName());
        ...
        return StringSubstitutor.replace(
                String.join(
                        "\n",
                        new String[] {
                            "final org.apache.flink.table.runtime.operators.calc.async.DelegatingAsyncResultFuture ${delegatingFuture} ",
                            "    = new org.apache.flink.table.runtime.operators.calc.async.DelegatingAsyncResultFuture(${collectorTerm});",
